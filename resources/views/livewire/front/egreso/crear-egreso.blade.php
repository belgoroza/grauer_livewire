<div>
    ...
    <x-jet-dialog-modal wire:model="open">
        ...
        <x-slot name="title"><span class="text-pink-600 border-b">Crear Un Nuevo Egreso</span></x-slot>
        ...
        <x-slot name="footer">
            ...
            <x-jet-danger-button wire:click="save">Crear Egreso</x-jet-danger-button>
        </x-slot>
