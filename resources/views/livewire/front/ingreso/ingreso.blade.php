            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <x-table >
                    <div class="py-2 px-2 flex justify-between">
                        ...
                        @livewire('front.ingreso.crear-ingreso')
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                          <td class="px-6 py-4 whitespace-nowrap">{{$ingreso->id}}</td>
                          <td class="px-6 py-4 whitespace-nowrap">{{$ingreso->id}}</td>
                        ...
                        @empty
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap"><span class="text-sm text-gray-600">[Error:01] | </span> No hay registros en Ingresos...</td>
                            </tr>
