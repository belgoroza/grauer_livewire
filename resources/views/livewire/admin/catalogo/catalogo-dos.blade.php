    ...
    <div x-data="setup()">
                  ...
                  <!-- Panel header -->
                    <div class="flex-shrink-0">  <!-- header fijo -->
                        <div class="px-4 py-2 border-b dark:border-indigo-800">
                            <input type="search" class="h-6 p-2 rounded" wire:model="search" placeholder="Buscar medida..."> 
                        </div>
                    </div>
                        ...
                        <div class="">
                            ...
                            <div class="flow-root border-b cursor-pointer" wire:click="activar({{ $resultado->id }},{{ $resultado->categoria_id}})">
                                <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                    <li class="py-3 sm:py-4 hover:bg-gray-100 px-1">
        ...
        <!--********* SIDEBAR ==> COLUMNA NÚMERO 3 (INICIO) ***************-->
            ...
            <main class="flex-1">
              ...
              <!-- <div class="bg-gray-800 text-white flex justify-center"> Favini Gorozy </div> -->
                @if($idProducto)
                  @forelse($resalt as $item)

                      <!-- <section class="mt-4"> -->
                          <div class="px-4 py-2 mx-auto h-screen">
                            <div class="max-w-4xl mx-auto mt-12 md:mt-8 lg:mt-8">
                              <div class="relative">
                                <div class="absolute inset-0 flex items-center" aria-hidden="true">
                                  <div class="w-full border-t border-gray-400"></div>
                                </div>
                                <div class="relative flex justify-start">
                                  <span class="pr-3 text-lg font-medium text-neutral-600 bg-gray-100"> Detalle del Producto </span>
                                </div>
                              </div>
                              ...
                              </div><div class="w-full my-2 border-t border-gray-400"></div>
        ...
        <div class="fixed flex items-center space-x-4 top-5 right-10 lg:hidden">
            ...
            <button
                ...
                class="p-1 mt-1 text-indigo-400 transition-colors duration-200 rounded-md bg-indigo-50 hover:text-indigo-600 hover:bg-indigo-100 dark:hover:text-light dark:hover:bg-indigo-700 dark:bg-dark focus:outline-none focus:ring">
            ...
            <!-- Open SIDEBAR ==> COLUMNA NÚMERO 2 (inicio) -->
            <button
